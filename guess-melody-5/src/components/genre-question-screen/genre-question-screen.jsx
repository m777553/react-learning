  ...
  return (
      ...
      <header className="game__header">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" className="timer" viewBox="0 0 780 780">
          <circle className="timer__line" cx="390" cy="390" r="370" style="filter: url(#blur); transform: rotate(-90deg) scaleY(-1); transform-origin: center"></circle>
        </svg>
        ...
        <form className="game__tracks">
          <div className="track">
            ...
            <div className="game__answer">
              ...
              <label className="game__check" for="answer-1">Отметить</label>
            </div>
          </div>
          ...
          <div className="track">
            ...
            <div className="game__answer">
              ...
              <label className="game__check" for="answer-2">Отметить</label>
            </div>
          </div>
          ...
          <div className="track">
            ...
            <div className="game__answer">
              ...
              <label className="game__check" for="answer-3">Отметить</label>
            </div>
          </div>
          ...
          <div className="track">
            ...
            <div className="game__answer">
              ...
              <label className="game__check" for="answer-4">Отметить</label>
            </div>
          </div>
